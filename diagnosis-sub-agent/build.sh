...
# Default values
IMAGE_NAME="diagnosis-sub-agent"
VERSION="test"
DOCKER_REGISTRY=""
SKIP_TESTS=true
SKIP_BUILD=false
...
Build and dockerize the diagnosis-sub-agent Spring Boot application.
...
EXAMPLES:
    ...
    $0 -v 1.0.11                                # Build with custom version
...
log_info "Starting diagnosis-sub-agent build process..."
