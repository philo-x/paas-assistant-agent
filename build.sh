...
# Module definitions
DEFAULT_MODULES="supervisor-agent platform-mcp-server diagnosis-sub-agent guide-sub-agent"
...
Build paas-agent-assistant modules.

DEFAULT MODULES (built by default):
    supervisor-agent (含前端), platform-mcp-server, diagnosis-sub-agent, 
    guide-sub-agent
...
EXAMPLES:
    ...
    $0 -v 1.0.11                                # Build default modules with version 1.0.11
    $0 -m all                                   # Build all modules including extras
    $0 -m supervisor-agent,platform-mcp-server  # Build only specific modules
...
echo ""
log_info "========================================="
log_info "PaaS Agent Assistant - Build All Modules"
log_info "========================================="
echo ""
